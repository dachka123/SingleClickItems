package com.example.singleclickitems
...
import com.example.singleclickitems.ui.theme.SIngleClickItemsTheme
...
private fun CardContent(name:String){
    ...
    Row(
        ...
        Column(
            ...
            if(expanded){
                Text(
                    text = ("me viyo ku" + "da kide isic").repeat(4)
                )
            }
        }
    ...
    Surface(color = MaterialTheme.colorScheme.primary, modifier = Modifier.padding(vertical = 4.dp, horizontal = 8.dp)) {
        Row(modifier = Modifier.padding(24.dp)) {
            ...
            ElevatedButton(onClick = {
                ...
                contentDescriop (if (expanded) "Show less" else "Show more")
            }
        }
    }*/
}
...
@Preview(showBackground = true, widthDp = 320, uiMode = Configuration.UI_MODE_NIGHT_YES, name = "GreetingPreviewDark")
